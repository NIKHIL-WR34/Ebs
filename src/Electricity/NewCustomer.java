...
public class NewCustomer extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            ...
            if (phone.length() > 10) {
                JOptionPane.showMessageDialog(null, "Phone number cannot be greater than 10 digits.");
                return;
            }
            
            String digitRegex = ".*[0-9].*";
            Pattern digitPattern = Pattern.compile(digitRegex);
            Matcher nameMatcher = digitPattern.matcher(name);
            Matcher stateMatcher = digitPattern.matcher(state);
            Matcher cityMatcher = digitPattern.matcher(city);
            ...
            if (stateMatcher.matches()) {
                JOptionPane.showMessageDialog(null, "State cannot contain digits.");
                return;
            }
            
            if (cityMatcher.matches()) {
                JOptionPane.showMessageDialog(null, "City cannot contain digits.");
                return;
            }
