...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String meter, String person){
        ...
        m6.setIcon(new ImageIcon(image1));
        m6.setMnemonic('O');
        m6.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O, ActionEvent.CTRL_MASK));
